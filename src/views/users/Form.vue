    ...
    methods: {
        ...
        save() {
            if (this.validateUser()) {
                if (this.users.id) {
                    this.$request
                        .put(`${process.env.VUE_APP_ROOT_API}/users/${this.users.id}`, this.users)
                        .then((res) => {
                            if (res.data.success) {
                                this.$router.push({
                                    name: 'userList',
                ...
                //create
                this.$request.post(`${process.env.VUE_APP_ROOT_API}/users`, this.users).then((res) => {
        ...
        getUser(userId) {
            this.$request.get(`${process.env.VUE_APP_ROOT_API}/users/${userId}`, this.users).then((res) => {
