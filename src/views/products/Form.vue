...
export default {
    ...
    created() {
        ...
        console.log('check.env', process.env.VUE_APP_ROOT_API);
    },
    methods: {
        validate() {
            let isValid = true;
        ...
        mounted() {
            console.log('check process.env.VUE_APP_ROOT_API', process.env.VUE_APP_ROOT_API);
        },
            ...
            if (this.validate()) {
                if (this.product.id) {
                    this.$request
                        ...
                        .put(`${process.env.VUE_APP_ROOT_API}/products/${this.product.id}`, this.product)
                        .then((res) => {
                ...
                this.$request.post(`${process.env.VUE_APP_ROOT_API}/products`, this.product).then((res) => {
                    console.log(res.data);
                    if (res.data.success) {
                        this.$router.push({
                            name: 'productList',
        ...
        getProduct(productId) {
            this.$request.get(`${process.env.VUE_APP_ROOT_API}/products/${productId}`).then((res) => {
